...
-- Tabla de variantes de artículos
CREATE TABLE public.variantes_articulos (
  ...
  CONSTRAINT variantes_articulos_fk_id_articulo_fkey FOREIGN KEY (fk_id_articulo) REFERENCES public.articulos(id),
  CONSTRAINT variantes_articulos_fk_id_talle_fkey FOREIGN KEY (fk_id_talle) REFERENCES public.talles(id),
  CONSTRAINT variantes_articulos_fk_id_color_fkey FOREIGN KEY (fk_id_color) REFERENCES public.color(id)
);
...
CREATE TABLE public.ordenes_venta_detalle (
  ...
  CONSTRAINT ordenes_venta_detalle_fk_id_talle_fkey FOREIGN KEY (fk_id_talle) REFERENCES public.talles(id),
  CONSTRAINT ordenes_venta_detalle_fk_id_color_fkey FOREIGN KEY (fk_id_color) REFERENCES public.color(id)
);
...
CREATE TABLE public.movimientos_stock (
  ...
  CONSTRAINT movimientos_stock_fk_id_talle_fkey FOREIGN KEY (fk_id_talle) REFERENCES public.talles(id),
  CONSTRAINT movimientos_stock_fk_id_color_fkey FOREIGN KEY (fk_id_color) REFERENCES public.color(id)
);
